...
def get_table_schema(table: Dict) -> str:
    ...
    datasets_tables_config_file_path = str(current_directory / table["tableSchemaPath"])
...
def get_datasets_with_tables_config() -> List[Dict]:
    current_directory = pathlib.Path(__file__).parent
    datasets_tables_config_file_path = str(current_directory / "resource/datasets_with_tables.json")
